 ...
 */
export class MockBankingProvider {
  #wallets = new Map();
  #transactions = new Map();
  #DEFAULT_BALANCE = 1000; // 1,000 MAD
  #TRANSACTION_FEE_PERCENTAGE = 0.02; // 2%
  #MIN_FEE = 5; // 5 MAD
  #MAX_FEE = 100; // 100 MAD
  #ERROR_INJECTION_RATE = 0.05; // 5% chance
  #NETWORK_DELAY_MIN = 100; // 100ms
  #NETWORK_DELAY_MAX = 500; // 500ms
   ...
   */
  setWalletBalance(contractId, balance) {
    const wallet = this.#getOrCreateWallet(contractId);
